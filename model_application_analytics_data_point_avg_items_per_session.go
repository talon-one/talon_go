...
type NullableApplicationAnalyticsDataPointAvgItemsPerSession struct {
	Value        ApplicationAnalyticsDataPointAvgItemsPerSession
	ExplicitNull bool
}

func (v NullableApplicationAnalyticsDataPointAvgItemsPerSession) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableApplicationAnalyticsDataPointAvgItemsPerSession) UnmarshalJSON(src []byte) error {
