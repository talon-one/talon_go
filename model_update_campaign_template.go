...
type UpdateCampaignTemplate struct {
	...
	CampaignAttributes *map[string]map[string]interface{} `json:"campaignAttributes,omitempty"`
	// The campaign attributes that coupons created from this template will have by default.
	CouponAttributes *map[string]map[string]interface{} `json:"couponAttributes,omitempty"`
