...
func BuildExtendedCoupon(id int64, created time.Time, campaignId int64, value string, usageLimit int64, usageCounter int64, applicationId int64) *ExtendedCoupon {
	this := ExtendedCoupon{}
	this.Id = id
