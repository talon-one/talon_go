...
func (o *InlineObject8) GetUpFile() string {
...
func (o *InlineObject8) GetUpFileOk() (string, bool) {
	if o == nil || o.UpFile == nil {
		var ret string
		return ret, false
	}
...
func (o *InlineObject8) HasUpFile() bool {
	if o != nil && o.UpFile != nil {
		return true
	}
...
func (o *InlineObject8) SetUpFile(v string) {
	o.UpFile = &v
}
