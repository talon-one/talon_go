...
// CouponWithApplication struct for CouponWithApplication
type CouponWithApplication struct {
...
func BuildCouponWithApplication(id int64, created time.Time, campaignId int64, value string, usageLimit int64, usageCounter int64, applicationId int64, applicationName string) *CouponWithApplication {
	this := CouponWithApplication{}
	this.Id = id
...
func (o CouponWithApplication) MarshalJSON() ([]byte, error) {
...
type NullableCouponWithApplication struct {
	value *CouponWithApplication
	isSet bool
}

func (v NullableCouponWithApplication) Get() *CouponWithApplication {
	return v.value
}

func (v *NullableCouponWithApplication) Set(val *CouponWithApplication) {
	v.value = val
	v.isSet = true
}

func (v NullableCouponWithApplication) IsSet() bool {
	return v.isSet
}

func (v *NullableCouponWithApplication) Unset() {
	v.value = nil
	v.isSet = false
}

func BuildNullableCouponWithApplication(val *CouponWithApplication) *NullableCouponWithApplication {
	return &NullableCouponWithApplication{value: val, isSet: true}
}

func (v NullableCouponWithApplication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCouponWithApplication) UnmarshalJSON(src []byte) error {
	v.isSet = true
