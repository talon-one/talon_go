...
`func (o *NewApplication) GetAttributes() map[string]map[string]interface{}`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *NewApplication) GetAttributesOk() (map[string]map[string]interface{}, bool)`
...
`func (o *NewApplication) SetAttributes(v map[string]map[string]interface{})`
