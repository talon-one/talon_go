...
`func (o *BaseLoyaltyProgram) GetTiersStartDate() time.Time`

GetTiersStartDate returns the TiersStartDate field if non-nil, zero value otherwise.

### GetTiersStartDateOk

`func (o *BaseLoyaltyProgram) GetTiersStartDateOk() (time.Time, bool)`
...
`func (o *BaseLoyaltyProgram) HasTiersStartDate() bool`

HasTiersStartDate returns a boolean if a field has been set.

### SetTiersStartDate

`func (o *BaseLoyaltyProgram) SetTiersStartDate(v time.Time)`
