...
> ActivateLoyaltyPointsResponse ActivateLoyaltyPoints(ctx, loyaltyProgramId, body)
...
> []BestPriorPrice BestPriorPrice(ctx, body)
...
> DeleteLoyaltyTransactionsFromLedgers(ctx, loyaltyProgramId, integrationId, body)
...
> InlineResponse2003 GetCustomerAchievementHistory(ctx, integrationId, achievementId, optional)
...
> InlineResponse2002 GetCustomerAchievements(ctx, integrationId, optional)
...
> InlineResponse2006 GetLoyaltyCardPoints(ctx, loyaltyProgramId, loyaltyCardId, optional)
...
> InlineResponse2004 GetLoyaltyCardTransactions(ctx, loyaltyProgramId, loyaltyCardId, optional)
...
> InlineResponse2007 GetLoyaltyProgramProfilePoints(ctx, loyaltyProgramId, integrationId, optional)
...
> InlineResponse2005 GetLoyaltyProgramProfileTransactions(ctx, loyaltyProgramId, integrationId, optional)
...
> InlineResponse2001 GetReservedCustomers(ctx, couponValue)
...
> InlineResponse200 IntegrationGetAllCampaigns(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***IntegrationGetAllCampaignsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a IntegrationGetAllCampaignsOpts struct
 ...
 **skip** | **optional.**| The number of items to skip when paging through large result sets. | 
 **campaignIds** | [**optional.Interface of []string**](string.md)| Filter by one or more campaign IDs, separated by a comma.  **Note:** If no campaigns are specified, data for all the campaigns in the Application is returned.  | 
 **startAfter** | **optional.**| Filter results to only include campaigns that start on or after  the specified timestamp.  **Note:**  - It must be an RFC3339 timestamp string.  - You can include a time component in your string, for example, &#x60;T23:59:59&#x60; to specify the end of the day. The time zone setting considered is &#x60;UTC&#x60;. If you do not include a time component, a default time value of &#x60;T00:00:00&#x60; (midnight) in &#x60;UTC&#x60; is considered.  | 
 ...
 **runRuleEngine** | **optional.**| When set to &#x60;true&#x60;, reevaluates the updated session after items are returned. Only reevaluates campaigns where &#x60;reevaluateOnReturn&#x60; is set to &#x60;true&#x60; and which produced an effect when the session was closed.  | 
...
> IntegrationEventV2Response TrackEventV2(ctx, body, optional)
