...
**Description** | **string** | A description of the attribute. | [default to null]
**Presets** | **[]string** | The presets that indicate to which industry the attribute applies to. | [default to null]
**Suggestions** | **[]string** | Short suggestions that are used to group attributes. | [default to null]
