...
`func (o *Event) GetAttributes() map[string]map[string]interface{}`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *Event) GetAttributesOk() (map[string]map[string]interface{}, bool)`
...
`func (o *Event) SetAttributes(v map[string]map[string]interface{})`
