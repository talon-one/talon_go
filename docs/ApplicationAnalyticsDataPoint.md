...
**TotalRevenue** | Pointer to [**AnalyticsDataPoint**](.md) |  | [optional] 
**SessionsCount** | Pointer to [**AnalyticsDataPoint**](.md) |  | [optional] 
**AvgItemsPerSession** | Pointer to [**AnalyticsDataPoint**](.md) |  | [optional] 
**AvgSessionValue** | Pointer to [**AnalyticsDataPoint**](.md) |  | [optional] 
