...
`func (o *ApplicationCustomer) GetAttributes() map[string]map[string]interface{}`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *ApplicationCustomer) GetAttributesOk() (map[string]map[string]interface{}, bool)`
...
`func (o *ApplicationCustomer) SetAttributes(v map[string]map[string]interface{})`
