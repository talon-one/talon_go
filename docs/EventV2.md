...
`func (o *EventV2) GetAttributes() map[string]map[string]interface{}`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *EventV2) GetAttributesOk() (map[string]map[string]interface{}, bool)`
...
`func (o *EventV2) SetAttributes(v map[string]map[string]interface{})`
