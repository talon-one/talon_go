...
**Data** | Pointer to [**[]Import**](Import.md) |  | 
...
`func (o *InlineResponse20029) GetDataOk() ([]Import, bool)`
...
SetData gets a reference to the given []Import and assigns it to the Data field.
