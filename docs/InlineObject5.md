...
`func (o *InlineObject5) GetUpFile() string`

GetUpFile returns the UpFile field if non-nil, zero value otherwise.

### GetUpFileOk

`func (o *InlineObject5) GetUpFileOk() (string, bool)`
...
`func (o *InlineObject5) HasUpFile() bool`

HasUpFile returns a boolean if a field has been set.

### SetUpFile

`func (o *InlineObject5) SetUpFile(v string)`
