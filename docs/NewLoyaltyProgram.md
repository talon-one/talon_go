...
`func (o *NewLoyaltyProgram) GetTiersStartDate() time.Time`

GetTiersStartDate returns the TiersStartDate field if non-nil, zero value otherwise.

### GetTiersStartDateOk

`func (o *NewLoyaltyProgram) GetTiersStartDateOk() (time.Time, bool)`
...
`func (o *NewLoyaltyProgram) HasTiersStartDate() bool`

HasTiersStartDate returns a boolean if a field has been set.

### SetTiersStartDate

`func (o *NewLoyaltyProgram) SetTiersStartDate(v time.Time)`
