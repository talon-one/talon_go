...
`func (o *InlineObject2) GetUpFile() string`

GetUpFile returns the UpFile field if non-nil, zero value otherwise.

### GetUpFileOk

`func (o *InlineObject2) GetUpFileOk() (string, bool)`
...
`func (o *InlineObject2) HasUpFile() bool`

HasUpFile returns a boolean if a field has been set.

### SetUpFile

`func (o *InlineObject2) SetUpFile(v string)`
