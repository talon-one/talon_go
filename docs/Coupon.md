...
`func (o *Coupon) GetAttributes() map[string]map[string]interface{}`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *Coupon) GetAttributesOk() (map[string]map[string]interface{}, bool)`
...
`func (o *Coupon) SetAttributes(v map[string]map[string]interface{})`
