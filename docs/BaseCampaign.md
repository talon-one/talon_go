...
`func (o *BaseCampaign) GetStoresImported() bool`

GetStoresImported returns the StoresImported field if non-nil, zero value otherwise.

### GetStoresImportedOk

`func (o *BaseCampaign) GetStoresImportedOk() (bool, bool)`
...
`func (o *BaseCampaign) HasStoresImported() bool`

HasStoresImported returns a boolean if a field has been set.

### SetStoresImported

`func (o *BaseCampaign) SetStoresImported(v bool)`
