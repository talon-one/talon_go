...
`func (o *InlineObject4) GetUpFile() string`

GetUpFile returns the UpFile field if non-nil, zero value otherwise.

### GetUpFileOk

`func (o *InlineObject4) GetUpFileOk() (string, bool)`
...
`func (o *InlineObject4) HasUpFile() bool`

HasUpFile returns a boolean if a field has been set.

### SetUpFile

`func (o *InlineObject4) SetUpFile(v string)`
