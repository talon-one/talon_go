...
**TotalRevenue** | Pointer to [**AnalyticsDataPointWithTrendAndInfluencedRate**](.md) |  | [optional] 
**SessionsCount** | Pointer to [**AnalyticsDataPointWithTrendAndInfluencedRate**](.md) |  | [optional] 
**AvgItemsPerSession** | Pointer to [**AnalyticsDataPointWithTrendAndUplift**](.md) |  | [optional] 
**AvgSessionValue** | Pointer to [**AnalyticsDataPointWithTrendAndUplift**](.md) |  | [optional] 
**TotalDiscounts** | Pointer to [**AnalyticsDataPointWithTrend**](.md) |  | [optional] 
**CouponsCount** | Pointer to [**AnalyticsDataPointWithTrend**](.md) |  | [optional] 
