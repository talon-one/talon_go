...
// IntegrationCouponAllOf struct for IntegrationCouponAllOf
type IntegrationCouponAllOf struct {
...
type NullableIntegrationCouponAllOf struct {
	Value IntegrationCouponAllOf
	ExplicitNull bool
}

func (v NullableIntegrationCouponAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableIntegrationCouponAllOf) UnmarshalJSON(src []byte) error {
