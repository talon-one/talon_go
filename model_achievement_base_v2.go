...
// AchievementBaseV2 struct for AchievementBaseV2
type AchievementBaseV2 struct {
...
func BuildAchievementBaseV2() *AchievementBaseV2 {
	this := AchievementBaseV2{}
	return &this
}
...
type NullableAchievementBaseV2 struct {
	value *AchievementBaseV2
	isSet bool
}

func (v NullableAchievementBaseV2) Get() *AchievementBaseV2 {
	return v.value
}

func (v *NullableAchievementBaseV2) Set(val *AchievementBaseV2) {
	v.value = val
	v.isSet = true
}

func (v NullableAchievementBaseV2) IsSet() bool {
	return v.isSet
}

func (v *NullableAchievementBaseV2) Unset() {
	v.value = nil
	v.isSet = false
}

func BuildNullableAchievementBaseV2(val *AchievementBaseV2) *NullableAchievementBaseV2 {
	return &NullableAchievementBaseV2{value: val, isSet: true}
}

func (v NullableAchievementBaseV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAchievementBaseV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
