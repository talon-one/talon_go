...
// ChangeAllOf struct for ChangeAllOf
type ChangeAllOf struct {
	...
	Old *map[string]map[string]interface{} `json:"old,omitempty"`
	// Resource after the change occurred.
	New *map[string]map[string]interface{} `json:"new,omitempty"`
...
type NullableChangeAllOf struct {
	Value ChangeAllOf
	ExplicitNull bool
}

func (v NullableChangeAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableChangeAllOf) UnmarshalJSON(src []byte) error {
