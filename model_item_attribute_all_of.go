...
// ItemAttributeAllOf struct for ItemAttributeAllOf
type ItemAttributeAllOf struct {
...
type NullableItemAttributeAllOf struct {
	Value ItemAttributeAllOf
	ExplicitNull bool
}

func (v NullableItemAttributeAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableItemAttributeAllOf) UnmarshalJSON(src []byte) error {
