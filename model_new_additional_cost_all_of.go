...
// NewAdditionalCostAllOf struct for NewAdditionalCostAllOf
type NewAdditionalCostAllOf struct {
...
type NullableNewAdditionalCostAllOf struct {
	Value NewAdditionalCostAllOf
	ExplicitNull bool
}

func (v NullableNewAdditionalCostAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableNewAdditionalCostAllOf) UnmarshalJSON(src []byte) error {
