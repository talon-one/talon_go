...
// ApplicationRefereeAllOf struct for ApplicationRefereeAllOf
type ApplicationRefereeAllOf struct {
...
type NullableApplicationRefereeAllOf struct {
	Value ApplicationRefereeAllOf
	ExplicitNull bool
}

func (v NullableApplicationRefereeAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableApplicationRefereeAllOf) UnmarshalJSON(src []byte) error {
