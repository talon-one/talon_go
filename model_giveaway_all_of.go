...
// GiveawayAllOf struct for GiveawayAllOf
type GiveawayAllOf struct {
...
type NullableGiveawayAllOf struct {
	Value GiveawayAllOf
	ExplicitNull bool
}

func (v NullableGiveawayAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableGiveawayAllOf) UnmarshalJSON(src []byte) error {
