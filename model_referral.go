...
func BuildReferral(id int64, created time.Time, usageLimit int64, campaignId int64, advocateProfileIntegrationId string, code string, usageCounter int64) *Referral {
	this := Referral{}
	this.Id = id
