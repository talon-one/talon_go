...
// NewCatalogAllOf struct for NewCatalogAllOf
type NewCatalogAllOf struct {
...
type NullableNewCatalogAllOf struct {
	Value NewCatalogAllOf
	ExplicitNull bool
}

func (v NullableNewCatalogAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableNewCatalogAllOf) UnmarshalJSON(src []byte) error {
