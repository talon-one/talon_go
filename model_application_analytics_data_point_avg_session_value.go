...
type NullableApplicationAnalyticsDataPointAvgSessionValue struct {
	Value        ApplicationAnalyticsDataPointAvgSessionValue
	ExplicitNull bool
}

func (v NullableApplicationAnalyticsDataPointAvgSessionValue) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableApplicationAnalyticsDataPointAvgSessionValue) UnmarshalJSON(src []byte) error {
