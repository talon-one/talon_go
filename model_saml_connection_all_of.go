...
// SamlConnectionAllOf A SAML 2.0 connection.
type SamlConnectionAllOf struct {
...
type NullableSamlConnectionAllOf struct {
	Value SamlConnectionAllOf
	ExplicitNull bool
}

func (v NullableSamlConnectionAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableSamlConnectionAllOf) UnmarshalJSON(src []byte) error {
