...
func BuildWebhookAuthentication(createdBy string, modifiedBy string, webhooks []WebhookAuthenticationWebhookRef, name string, type_ string, data map[string]interface{}, id int64, created time.Time, modified time.Time) *WebhookAuthentication {
