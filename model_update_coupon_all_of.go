...
// UpdateCouponAllOf struct for UpdateCouponAllOf
type UpdateCouponAllOf struct {
...
type NullableUpdateCouponAllOf struct {
	Value UpdateCouponAllOf
	ExplicitNull bool
}

func (v NullableUpdateCouponAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableUpdateCouponAllOf) UnmarshalJSON(src []byte) error {
