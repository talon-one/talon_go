...
type NullableApplicationAnalyticsDataPointTotalRevenue struct {
	Value        ApplicationAnalyticsDataPointTotalRevenue
	ExplicitNull bool
}

func (v NullableApplicationAnalyticsDataPointTotalRevenue) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableApplicationAnalyticsDataPointTotalRevenue) UnmarshalJSON(src []byte) error {
