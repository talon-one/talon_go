...
// BaseCampaignForNotification struct for BaseCampaignForNotification
type BaseCampaignForNotification struct {
...
type NullableBaseCampaignForNotification struct {
	Value        BaseCampaignForNotification
	ExplicitNull bool
}

func (v NullableBaseCampaignForNotification) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableBaseCampaignForNotification) UnmarshalJSON(src []byte) error {
