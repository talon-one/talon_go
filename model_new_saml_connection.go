...
func BuildNewSamlConnection(x509certificate string, accountId int64, name string, enabled bool, issuer string, signOnURL string) *NewSamlConnection {
...
func BuildNullableNewSamlConnection(val *NewSamlConnection) *NullableNewSamlConnection {
