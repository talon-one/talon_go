...
type NullableApplicationCampaignAnalyticsAvgItemsPerSession struct {
	Value        ApplicationCampaignAnalyticsAvgItemsPerSession
	ExplicitNull bool
}

func (v NullableApplicationCampaignAnalyticsAvgItemsPerSession) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableApplicationCampaignAnalyticsAvgItemsPerSession) UnmarshalJSON(src []byte) error {
