...
type NullableApplicationCampaignAnalyticsTotalRevenue struct {
	Value        ApplicationCampaignAnalyticsTotalRevenue
	ExplicitNull bool
}

func (v NullableApplicationCampaignAnalyticsTotalRevenue) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableApplicationCampaignAnalyticsTotalRevenue) UnmarshalJSON(src []byte) error {
