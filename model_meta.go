...
type Meta struct {
	...
	Campaigns *map[string]map[string]interface{} `json:"campaigns,omitempty"`
	// Maps the coupon value to a key-value list of that coupons attributes.
	Coupons *map[string]map[string]interface{} `json:"coupons,omitempty"`
	...
	Warnings *map[string]map[string]interface{} `json:"warnings,omitempty"`
}
