...
func (o CampaignCollectionEditedNotificationItem) MarshalJSON() ([]byte, error) {
...
type NullableCampaignCollectionEditedNotificationItem struct {
	value *CampaignCollectionEditedNotificationItem
	isSet bool
}

func (v NullableCampaignCollectionEditedNotificationItem) Get() *CampaignCollectionEditedNotificationItem {
	return v.value
}

func (v *NullableCampaignCollectionEditedNotificationItem) Set(val *CampaignCollectionEditedNotificationItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignCollectionEditedNotificationItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignCollectionEditedNotificationItem) Unset() {
	v.value = nil
	v.isSet = false
}
...
func (v NullableCampaignCollectionEditedNotificationItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignCollectionEditedNotificationItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
