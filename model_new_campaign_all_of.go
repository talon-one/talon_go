...
// NewCampaignAllOf struct for NewCampaignAllOf
type NewCampaignAllOf struct {
...
type NullableNewCampaignAllOf struct {
	Value NewCampaignAllOf
	ExplicitNull bool
}

func (v NullableNewCampaignAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableNewCampaignAllOf) UnmarshalJSON(src []byte) error {
