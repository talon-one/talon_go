...
func (o PendingPointsNotificationPolicy) MarshalJSON() ([]byte, error) {
...
func (v NullablePendingPointsNotificationPolicy) Get() *PendingPointsNotificationPolicy {
	return v.value
}

func (v *NullablePendingPointsNotificationPolicy) Set(val *PendingPointsNotificationPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullablePendingPointsNotificationPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullablePendingPointsNotificationPolicy) Unset() {
	v.value = nil
	v.isSet = false
}
