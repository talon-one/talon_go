...
// LimitCounterAllOf struct for LimitCounterAllOf
type LimitCounterAllOf struct {
...
type NullableLimitCounterAllOf struct {
	Value LimitCounterAllOf
	ExplicitNull bool
}

func (v NullableLimitCounterAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableLimitCounterAllOf) UnmarshalJSON(src []byte) error {
