...
// InventoryReferralAllOf struct for InventoryReferralAllOf
type InventoryReferralAllOf struct {
...
type NullableInventoryReferralAllOf struct {
	Value InventoryReferralAllOf
	ExplicitNull bool
}

func (v NullableInventoryReferralAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableInventoryReferralAllOf) UnmarshalJSON(src []byte) error {
