...
func BuildIntegrationCoupon(id int64, created time.Time, campaignId int64, value string, usageLimit int64, usageCounter int64, profileRedemptionCount int64) *IntegrationCoupon {
...
func (o IntegrationCoupon) MarshalJSON() ([]byte, error) {
...
func (v NullableIntegrationCoupon) Get() *IntegrationCoupon {
	return v.value
}

func (v *NullableIntegrationCoupon) Set(val *IntegrationCoupon) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationCoupon) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationCoupon) Unset() {
	v.value = nil
	v.isSet = false
}
