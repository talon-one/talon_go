...
// LibraryAttributeAllOf struct for LibraryAttributeAllOf
type LibraryAttributeAllOf struct {
...
type NullableLibraryAttributeAllOf struct {
	Value LibraryAttributeAllOf
	ExplicitNull bool
}

func (v NullableLibraryAttributeAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableLibraryAttributeAllOf) UnmarshalJSON(src []byte) error {
