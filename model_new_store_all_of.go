...
// NewStoreAllOf struct for NewStoreAllOf
type NewStoreAllOf struct {
...
type NullableNewStoreAllOf struct {
	Value NewStoreAllOf
	ExplicitNull bool
}

func (v NullableNewStoreAllOf) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableNewStoreAllOf) UnmarshalJSON(src []byte) error {
