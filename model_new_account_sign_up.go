...
func BuildNewAccountSignUp(email string, password string, companyName string) *NewAccountSignUp {
...
func BuildNullableNewAccountSignUp(val *NewAccountSignUp) *NullableNewAccountSignUp {
